...
cmake ../find_libs -DCMAKE_PREFIX_PATH="$CMAKE_PREFIX_PATH;$ANDROID_NDK/platforms/android-22/arch-arm/usr/lib" \
...
lib_output=$($my_loc/parse_libs.py $full_library_list $ANDROID_NDK/platforms/android-22/arch-arm/usr/lib)
